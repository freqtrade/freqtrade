...
| `liquidation_warn_ratio` | Notify when less than this fraction of the distance between a position's open rate and its liquidation stop is left. Set to `0` to disable [leverage documentation](leverage.md#liquidation-warnings). <br>*Defaults to `0.2`.*  <br> **Datatype:** Float
| | **Unfilled timeout**
