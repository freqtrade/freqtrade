    ...
    <div className="min-h-screen">
      <nav className="border-b border-dark-700 px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="/my-bot" className="text-accent font-medium">My Bot</a>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 space-y-8">
        <h1 className="text-3xl font-bold text-white">My Bot</h1>
        ...
        {user?.isWhitelisted && !hasKey && (
          <div className="bg-dark-800 rounded-xl p-6 flex items-center justify-between border border-dark-700">
            <div>
        ...
        <div className="bg-dark-800 rounded-xl p-6 border border-dark-700">
          <h2 className="text-lg font-semibold text-white mb-4">Your Trade History</h2>
          <div className="text-gray-500 text-center py-8">
            {hasKey ? "Bot is running — your trades will appear here" : "Configure your MEXC API keys to start trading"}
          </div>
        </div>
      </div>
    </div>
