    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-2xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="bg-dark-800 rounded-xl p-6 space-y-3 opacity-75">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <span className="text-white ml-2">TrendRider v2</span>
            </div>
            <div>
              <span className="text-gray-500">Timeframe:</span>
              <span className="text-white ml-2">5m</span>
            </div>
            <div>
              <span className="text-gray-500">Stop Loss:</span>
              <span className="text-white ml-2">-0.9%</span>
            </div>
            <div>
              <span className="text-gray-500">Trailing:</span>
              <span className="text-white ml-2">0.3% @ 1.2%</span>
            </div>
          </div>
          <p className="text-xs text-gray-600">
            Strategy parameters are managed by the TrendRider team and cannot be modified.
          </p>
        </div>
        ...
        <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-4 text-sm text-yellow-200/70">
          ...
          Spot Trading permissions. Never enable Withdrawal. TrendRider encrypts
          your keys but you are responsible for your account security.
        </div>
      </div>
    </div>
  );
