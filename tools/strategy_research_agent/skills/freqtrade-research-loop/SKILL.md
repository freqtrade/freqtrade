...
2. **Generate or refresh hypotheses**
   ```bash
...
3. **Backtest with Freqtrade**
   Use the repo agent or native Freqtrade. Always state timeframe, timerange, pair universe, fee, leverage, and config.
