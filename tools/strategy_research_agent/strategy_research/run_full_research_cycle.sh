...
Runs the research-only strategy cycle:
  ...
  5. Build BTC regime and base/stress cost experiments.
  6. Run base and stress candidate matrices with Freqtrade backtesting.
  7. Summarize matrix robustness.
  8. Build scorecards and failure diagnostics.
  9. Refresh the dashboard/report without live trading.
