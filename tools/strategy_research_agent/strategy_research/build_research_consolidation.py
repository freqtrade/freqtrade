...
def build_payload() -> dict[str, Any]:
    ...
    payload = {
        ...
        "promotion_boundaries": [
            ...
            "Promotion gate is family-level: evaluate target-regime edge plus hostile-regime loss containment under router, cooldown, drawdown, and consecutive-loss circuit breakers, not naked all-regime performance alone.",
        ...
        "agent_prompt_contract": [
            ...
            "A family may be a dry-run review candidate only when its target-regime edge survives and hostile-regime losses are contained by family-level drawdown, cooldown, and consecutive-loss guards.",
