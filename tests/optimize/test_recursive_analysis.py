...
from freqtrade.optimize.analysis.recursive_analysis_helpers import RecursiveAnalysisSubFunctions
...
def test_start_recursive_analysis(mocker):
    ...
    mocker.patch.multiple(
        'freqtrade.optimize.analysis.recursive_analysis_helpers.RecursiveAnalysisSubFunctions',
...
def test_initialize_single_recursive_analysis(recursive_conf, mocker, caplog):
    ...
    start_mock = mocker.patch(
        'freqtrade.optimize.analysis.recursive_analysis.RecursiveAnalysis.start')
    strategy_obj = {
        'name': "strategy_test_v3_recursive_issue",
        'location': Path(recursive_conf['strategy_path'], f"{recursive_conf['strategy']}.py")
    }
