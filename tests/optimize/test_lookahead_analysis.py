...
from freqtrade.optimize.analysis.lookahead_analysis import Analysis, LookaheadAnalysis
from freqtrade.optimize.analysis.lookahead_analysis_helpers import LookaheadAnalysisSubFunctions
...
def test_start_lookahead_analysis(mocker):
    ...
    mocker.patch.multiple(
        'freqtrade.optimize.analysis.lookahead_analysis_helpers.LookaheadAnalysisSubFunctions',
...
def test_initialize_single_lookahead_analysis(lookahead_conf, mocker, caplog):
    ...
    start_mock = mocker.patch(
        'freqtrade.optimize.analysis.lookahead_analysis.LookaheadAnalysis.start')
    strategy_obj = {
        'name': "strategy_test_v3_with_lookahead_bias",
        'location': Path(lookahead_conf['strategy_path'], f"{lookahead_conf['strategy']}.py")
    }
