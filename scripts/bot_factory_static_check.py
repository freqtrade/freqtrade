...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Bot Factory static safety checks.")
    parser.add_argument(
        "paths",
        nargs="*",
...
def main() -> int:
    ...
    print(f"Static check report written: {output}")
...
def _default_output_path() -> Path:
    ...
    return Path("registry") / "strategies" / "checks" / f"{ts}_static_check.json"
