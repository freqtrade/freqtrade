...
class Hyperopt:
    ...
    def export_csv_file(config: dict, results: list, total_epochs: int, highlight_best: bool,
        ...
        base_metrics_columns = ['Best', 'Epoch', 'Trades', 'Avg profit', 'Total profit', 'Stake currency',
                               'Profit', 'Avg duration', 'Objective', 'is_initial_point', 'is_best']
        param_metrics_columns = list(results[0]['params_dict'].keys())
        trials.columns = base_metrics_columns + param_metrics_columns
